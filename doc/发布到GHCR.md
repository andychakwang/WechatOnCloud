...
```bash
git tag andy-automation-usable-r5-2026-06-17
git push origin andy-automation-usable-r5-2026-06-17
# 产出 ghcr.io/<owner>/woc-panel:andy-automation-usable-r5-2026-06-17
# 以及 ghcr.io/<owner>/wechat-on-cloud:andy-automation-usable-r5-2026-06-17
```
