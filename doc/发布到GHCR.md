...
```bash
git tag andy-automation-usable-r13-2026-07-05
git push origin andy-automation-usable-r13-2026-07-05
# 产出 ghcr.io/<owner>/woc-panel:andy-automation-usable-r13-2026-07-05
# 以及 ghcr.io/<owner>/wechat-on-cloud:andy-automation-usable-r13-2026-07-05
```
