...
```bash
git tag andy-automation-usable-r8-2026-06-25
git push origin andy-automation-usable-r8-2026-06-25
# 产出 ghcr.io/<owner>/woc-panel:andy-automation-usable-r8-2026-06-25
# 以及 ghcr.io/<owner>/wechat-on-cloud:andy-automation-usable-r8-2026-06-25
```
